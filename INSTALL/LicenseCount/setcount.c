...
#define PAGE_COUNT_OFFSET 0x240 // offset is byte index into device driver for max PAGER device count
#define COM_COUNT_OFFSET 0x242  // offset is byte index into device driver for max COM device count
